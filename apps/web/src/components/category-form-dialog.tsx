...
export function CategoryFormDialog({
	...
	const createMutation = useMutation({
		mutationFn: async (data: { name: string; notes?: string | null }) => {
			const res = await eden.api.categories.post(data);
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: category?.id triggers re-populate
	useEffect(() => {
		if (open) {
			form.setFieldValue("name", category?.name ?? "");
			form.setFieldValue("notes", category?.notes ?? "");
		}
